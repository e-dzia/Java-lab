...
public class GameWindow extends JFrame {
    ...
    public GameWindow() {
        ...
        kolejnaRundaButton.addActionListener(e -> {
            ...
            if (game.round % 2 != 0){
                //najpierw komputer
                txtCardComputer.setText(game.computerPlayer.chooseCard(-1, (String) cmbStrategy.getSelectedItem()) + "");
            }
            else {
                //najpierw człowiek
                txtCardComputer.setText("");
        ...
        gotoweButton.addActionListener(e -> {
            ...
            if (game.round %2 == 0){
                //najpierw człowiek
                txtCardComputer.setText(game.computerPlayer.chooseCard((int) cmbCardsPlayer.getSelectedItem(), (String) cmbStrategy.getSelectedItem()) + "");
            }
            cmbCardsPlayer.setEnabled(false);
            ready = true;
        });
    
        DefaultComboBoxModel model2 = new DefaultComboBoxModel(findScript().toArray());
        cmbStrategy.setModel(model2);
