...
Nale¿y zaprojektowaæ warstwowy sieciowy system wymiany wiadomoœci, sk³adaj¹cy siê z pewnej liczby osobnych aplikacji (konsolowych lub okienkowych) w architekturze takiej jak na poni¿szym obrazku (plik soap.png). Strza³ki reprezentuj¹ mo¿liwy kierunek przekazywania wiadomoœci.
...
Przydatne:
https://doszhan.com/2015/06/28/tutorial-how-to-create-axis2-web-service-with-intellij-idea-part-1-service-side/